...
const API_URL = process.env.REACT_APP_CHAT_API_URL || "http://localhost:11434/api/chat";
const DEFAULT_MODEL = process.env.REACT_APP_CHAT_MODEL || "aprilo";
const ChatWindow = () => {
  ...
  const [apiSettings, setApiSettings] = useState({
    endpoint: localStorage.getItem("chat_api_endpoint") || API_URL,
    model: localStorage.getItem("chat_api_model") || DEFAULT_MODEL
  });
  ...
  const saveSettings = (newSettings) => {
    ...
    localStorage.setItem("chat_api_endpoint", newSettings.endpoint);
    localStorage.setItem("chat_api_model", newSettings.model);
    ...
    <div className="chat-container">
      ...
      {isOpen && (
        <div className="chat-window">
          <div className="chat-header">Welcome to ApriloBot</div>
